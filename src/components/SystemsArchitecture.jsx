...
const stages = [
  ...
  },
  {
    ...
    fixDetail: 'Personalized landing pages, direct mail, coordinated outreach. 46% engagement rate. 3 closed deals worth $340K.',
    healthyMetric: { val: '$340K', label: 'ABM Revenue' },
